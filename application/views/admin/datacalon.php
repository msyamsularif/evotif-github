...
<div class="box">
	<div class="box-inner">
		<div class="box-header well">
			<h2>Data Calon Ketua HIMATIF</h2>
		</div>
				...
				?>
					<tr>
						...
						<td>
							...
							<a class="btn btn-info" href="<?php echo base_url(); ?>index.php/admin/editcalon/<?php echo $loaddata['nim']; ?>">
								<i class="glyphicon glyphicon-edit icon-white"></i>
								Edit
							</a>
							<a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/admin/hapuscalon/<?php echo $loaddata['nim']; ?>">
