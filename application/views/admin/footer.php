...
<?php if (!isset($no_visible_elements) || !$no_visible_elements) { ?>
    ...
    <footer class="row">
        <p class="col-md-4 col-sm-6 col-xs-6 copyright">&copy; <?php echo date('Y') ?><a href="#" target="_blank"> Muhammad Syamsul Arif</a></p>
		<p class="col-md-4 col-sm-6 col-xs-6 copyright text-center"><b><a href="https://github.com/fpls-software/pilketos" target="_blank">E - VOTIF v.0.1.0-Beta</a></b></p>
        <p class="col-md-4 col-sm-6 col-xs-6 powered-by">Powered by: 
		<a href="#"><?php echo $load['nm_kampus']; ?></a></p>
    </footer>
<?php } ?>
