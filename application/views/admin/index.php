...
<div class=" row">
    <div class="col-md-6 col-sm-6 col-xs-6">
        <a data-toggle="tooltip" class="well top-block" href="<?php echo base_url("index.php/admin/datacalon"); ?>">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        <a data-toggle="tooltip" class="well top-block" href="<?php echo base_url("index.php/admin/datadpt"); ?>">
        ...
        <div class="box-content">
            ...
            ?>
                ...
                <?php
                    ...
                    echo form_input($form_attribute);
                ?><br/>
                <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-save"></span> Simpan Data</button>
            <?php 
                echo form_close(); 
            ?>
        </div>
    ...
    <div class="col-lg-6">
        <div class="box">
            <div class="box-inner">
             ...
             <div class="box-content">
             <p>Fitur ini akan menghapus semua data Kecuali Indentitas Kampus dan Data Kelas</p>
			...
			<?php } ?>
				<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#reset"><span class="glyphicon glyphicon-remove"></span> Reset Data Pemilihan</button>
        ...
        <div class="box">
			...
			<?php } ?>
                ...
                ?>
                    ...
                    ?>
                    <br/>
                    <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Reset User</button>
                <?php 
                    echo form_close();
                ?>
             </div>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Tentang E-VOTIF</h2>

                
            </div>
            <div class="box-content">
                <p> E-VOTIF Adalah sebuah aplikasi yang didesain khusus untuk Pemilihan Ketua HIMATIF <br/>
					Aplikasi ini menggunakan Template <b>Charisma</b> dan dibangun menggunakan Framework <b>Code Igniter</b> 
					<br/><br/>
					Dengan adanya Aplikasi ini saya harap dapat membatu Himpunan Mahasiswa teknik Informatika UNKRIS untuk melakukan Vote Calon Ketua HIMATIF
				</p>
            </div>
        </div>
    </div>
